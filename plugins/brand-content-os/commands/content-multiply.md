...
1. **Load brand knowledge**: Read ALL files from the `brand-os/` directory. Every file is relevant for this command. If missing, suggest running `/brand-setup` first.
...
- Offer to save the bundle as a markdown file in the user's folder
